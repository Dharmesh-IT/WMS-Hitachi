    ...
    public static class EncryptDecrypt
    {
        ...
        public static string Decrypt(string encryptedText, string key, string iv)
        {
            try
            {
                ...
                string encrytedTextNew = "";string decText = "";
                ...
                byte[] encrypted = Encryption.EncryptStringToBytes(encrytedTextNew, keyBytes, ivBytes);
               
                decText = Encryption.DecryptStringFromBytes(encrypted, keyBytes, ivBytes);

                //byte[] plainTextByte = Array.ConvertAll<string, byte>(decText.Split('-'), s => Convert.ToByte(s, 16));
                //byte[] CipherText = encrypto.TransformFinalBlock(plainTextByte, 0, plainTextByte.Length);
                return decText;
            }
            catch
