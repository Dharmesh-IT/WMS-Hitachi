...
namespace WMSWebApp.Controllers
{
    ...
    public class AuthenticateController : ControllerBase
    {
        ...
        private IHitachiConnection _hitachiConnection;
        public AuthenticateController(IConfiguration iconfig, IUserService userService, IHitachiConnection hitachiConnection)
        {
